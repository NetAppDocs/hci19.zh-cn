...
* 如果要从管理节点 12.2 升级： a management node to version 12.3.x from 12.2
* 如果要从管理节点 12.0 升级： a management node to version 12.3.x from 12.0
* 如果要从管理节点 11.3 ， 11.5 ， 11.7 或 11.8 升级： a management node to version 12.3.x from 11.3 through 11.8
* 如果要从管理节点 11.0 或 11.1 升级： a management node to version 12.3.x from 11.1 or 11.0
* 如果要从管理节点 10.x 版升级： from management node version 10.x to 11.x
...
* 如果要保留现有管理节点： authentication using the management node REST API
